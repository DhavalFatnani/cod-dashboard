...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  return getOrCreateIdempotent(idk, "POST", `/finance/deposit/${id}/reconcile`, async () => {
    // In real impl: reconcile against bank txn
    return { status: 200, body: { reconciled: true, depositId: id, requestId } };
